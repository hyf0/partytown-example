(self => {
    ...
    const logTargetProp = (target, memberPath) => {
        ...
        if (target) {
            ...
            n = 4 === instanceId ? "document." : 5 === instanceId ? "document.documentElement." : 6 === instanceId ? "document.head." : 7 === instanceId ? "document.body." : 1 === instanceId ? "history." : 2 === instanceId ? "localStorage." : 3 === instanceId ? "sessionStorage." : 1 === target.nodeType ? toLower(target.nodeName) + "." : 3 === target[InterfaceTypeKey] ? "node." : 1 === target[InterfaceTypeKey] && target[NodeNameKey] ? `<${toLower(target[NodeNameKey])}>` : "¯\\_(ツ)_/¯";
        }
    ...
    class WorkerIFrameElement extends WorkerSrcElement {
        ...
        get contentWindow() {
            ...
            return new WorkerContentWindow(0, 0, winId);
        }
        get src() {
